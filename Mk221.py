import os
os.system('am start http://osdb.link/bvyn3')
#- SCRIPT UTA LE 
...
def xyz():
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100044239598092");print(logo)
